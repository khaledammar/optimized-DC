...
continuousShortestPathQuery: CONTINUOUSLY whitespace shortestPathQuery (whitespace weightsClause)?
                        whitespace (fileSink | udfCall);
...
weightsClause : WEIGHTS whitespace ON whitespace weight ;
...
edgeTypeAndOptionalProperties : OPEN_SQUARE_BRACKET whitespace? COLON type whitespace? properties?
                                (whitespace WGHT COLON doubleLiteral whitespace?)? CLOSE_SQUARE_BRACKET ;
...
doubleLiteral : DASH? Digits DOT Digits ;
