...
public class QueryAggregation {
     ...
     */
    public QueryAggregation(AggregationFunction aggregationFunction, Pair<String, String> variableWithProperty) {
        this.aggregationFunction = aggregationFunction;
    ...
    public static boolean isSameAs(QueryAggregation a, QueryAggregation b) {
        ...
        return Objects.equals(a.aggregationFunction, b.aggregationFunction) && Objects.equals(a.variable, b.variable) &&
    ...
    public String toString() {
        ...
        tmpString += (null != variable) ? variable : variablePropertyPair.a + "." + variablePropertyPair.b;
        return tmpString + ")";
    }
}
