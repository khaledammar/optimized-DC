...
public class GenericJoinIntersectionRule {
     ...
     */
    public GenericJoinIntersectionRule(int prefixIndex, Direction direction, short fromVertexTypeFilter,
                                       short toVertexTypeFilter, short edgeTypeFilter) {
        this(prefixIndex, direction, GraphVersion.PERMANENT, fromVertexTypeFilter, toVertexTypeFilter, edgeTypeFilter);
    }
     ...
     *                             ignored.
     */
    public GenericJoinIntersectionRule(int prefixIndex, Direction direction, GraphVersion graphVersion,
    ...
    public static boolean isSameAs(GenericJoinIntersectionRule a, GenericJoinIntersectionRule b) {
        ...
        return a.prefixIndex == b.prefixIndex && a.direction == b.direction && a.graphVersion == b.graphVersion &&
                a.edgeTypeFilter == b.edgeTypeFilter;
    }
    ...
    public String toString() {
        return ("prefixIndex: " + prefixIndex) + ", direction: " + direction.name() + ", graph-version: " +
                graphVersion.name() + ", fromVertexTypeFilter: " + fromVertexTypeFilter + ", toVertexTypeFilter: " +
                toVertexTypeFilter + ", edgeTypeFilter: " + edgeTypeFilter;
    }
}
