...
public class Sum extends AbstractLongDoubleAggregator {
    ...
    protected void aggregateInt(int index, int intValue) {
        this.longValues =
                ArrayUtils.resizeIfNecessary(longValues, index + 1, 0 /* value to fill new cells if resizing */);
    ...
    protected void aggregateDouble(int index, double doubleValue) {
        this.doubleValues =
                ArrayUtils.resizeIfNecessary(doubleValues, index + 1, 0 /* value to fill new cells if resizing */);
