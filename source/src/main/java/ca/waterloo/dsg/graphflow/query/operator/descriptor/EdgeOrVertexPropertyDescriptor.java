...
public class EdgeOrVertexPropertyDescriptor implements JsonOutputable {
    ...
    public JsonObject toJson() {
        ...
        if (COUNTSTAR_DUMMY_DESCRIPTOR == this) {
            jsonDescriptor.addProperty(JsonKeyConstants.TYPE.toString(), JsonKeyConstants.
                COUNT_STAR_DESCRIPTOR.toString());
        } else {
            jsonDescriptor.addProperty(JsonKeyConstants.TYPE.toString(), descriptorType.toString());
            jsonDescriptor.addProperty(JsonKeyConstants.INDEX.toString(), index);
            jsonDescriptor.addProperty(JsonKeyConstants.KEY.toString(), key);
        }
