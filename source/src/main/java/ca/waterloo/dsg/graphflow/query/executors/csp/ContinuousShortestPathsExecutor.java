 ...
 **/
public class ContinuousShortestPathsExecutor {

    private static final ContinuousShortestPathsExecutor INSTANCE = new ContinuousShortestPathsExecutor();
     ...
     * class.
     */
    private ContinuousShortestPathsExecutor() {
    }

    /**
     * Returns the singleton instance {@link #INSTANCE} of {@link ContinuousShortestPathsExecutor}.
     */
    public static ContinuousShortestPathsExecutor getInstance() {
        return INSTANCE;
    }
