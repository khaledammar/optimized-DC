...
public enum DataType {
    ...
    public static DataType mapStringToDataType(String stringDataType) {
        ...
        throw new IllegalArgumentException("The data type " + stringDataType + " is not " + "supported.");
    }
    ...
    public static void assertValueCanBeCastToDataType(DataType dataType, String stringValue) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "The string value " + stringValue + " can not be " + "parsed as " + dataType.name() + ".");
        }
    }
    ...
    public static boolean equals(DataType dataType, Object thisValue, String thatValue) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Either one of the string values can not be cast" + " to " + dataType.name() + ".");
        }

        throw new IllegalArgumentException("The data type " + dataType + " is null or not " + "supported.");
    }
    ...
    public static byte[] serialize(DataType dataType, short key, String value) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "The string value " + value + " can not be parsed" + " as " + dataType.name().toUpperCase() + ".");
        }
    ...
    public static Object deserialize(DataType dataType, byte[] data, int startIndex, int length) {
        if (INTEGER == dataType) {
            ...
            return new String(Arrays.copyOfRange(data, startIndex, startIndex + length), StandardCharsets.UTF_8);
        }
