...
public class IOUtils {
     ...
     */
    public static ObjectOutputStream constructObjectOutputStream(String outputFilePath) throws IOException {
        return new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(outputFilePath)));
    }
     ...
     */
    public static ObjectInputStream constructObjectInputStream(String inputFilePath) throws IOException {
