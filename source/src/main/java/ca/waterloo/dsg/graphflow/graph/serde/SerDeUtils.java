...
public class SerDeUtils {
    ...
    private static final String FILE_NAME_TEMPLATE = "graphflow_%s%s.data";
    ...
    public static String getMainFilePath(String directoryPath, String className) {
        return directoryPath + File.separator +
                String.format(FILE_NAME_TEMPLATE, String.format(MAIN_FILE_TEMPLATE, className),
                        Graph.FILE_SUFFIX.isEmpty() ? "" : "." + Graph.FILE_SUFFIX);
    }
     ...
     */
    public static String getMetadataFilePath(String directoryPath, String className, String arrayName) {
        return directoryPath + File.separator +
                String.format(FILE_NAME_TEMPLATE, String.format(METADATA_FILE_TEMPLATE, className, arrayName),
                        Graph.FILE_SUFFIX.isEmpty() ? "" : "." + Graph.FILE_SUFFIX);
    }
     ...
     */
    public static String getArrayBlockFilePath(String directoryPath, String className, String arrayName,
                                               int blockIndex) {
        return directoryPath + File.separator +
                String.format(FILE_NAME_TEMPLATE, String.format(BLOCK_FILE_TEMPLATE, className, arrayName, blockIndex),
                        Graph.FILE_SUFFIX.isEmpty() ? "" : "." + Graph.FILE_SUFFIX);
    }
}
