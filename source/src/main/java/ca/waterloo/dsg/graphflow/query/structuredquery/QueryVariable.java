...
public class QueryVariable implements AbstractStructuredQuery {
    ...
    public static boolean isSameAs(QueryVariable a, QueryVariable b) {
        ...
        if (!Objects.equals(a.variableName, b.variableName) || !Objects.equals(a.variableType, b.variableType)) {
            return false;
        }

        if (null == a.variableProperties && null == b.variableProperties) {
            return true;
        } else if ((null != a.variableProperties && null == b.variableProperties) || (null == a.variableProperties) ||
                (a.variableProperties.size() != b.variableProperties.size())) {
            return false;
        }
        for (String key : a.variableProperties.keySet()) {
            if (!a.variableProperties.get(key).b.equals((b.variableProperties.get(key).b)) ||
                    !a.variableProperties.get(key).a.toUpperCase()
                            .equals((b.variableProperties.get(key).a.toUpperCase()))) {
                return false;
            }
        }
