...
public abstract class AbstractDBOperator implements JsonOutputable {
     ...
     */
    protected static <T> void appendListAsCommaSeparatedString(StringBuilder stringBuilder, List<T> objects,
                                                               String prefix) {
    ...
    public String getHumanReadablePlan() {
        ...
        while (null != operator) {
            stringBuilder.append(getIndentedString("nextOperator -> " + operator.getHumanReadableOperator(), level++));
