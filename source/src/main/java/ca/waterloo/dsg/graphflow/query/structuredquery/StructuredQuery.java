...
public class StructuredQuery implements AbstractStructuredQuery {
    ...
    private String shortestPathWeight;
    ...
    public static boolean isSameAs(StructuredQuery a, StructuredQuery b) {
        ...
        for (int i = 0; i < a.queryAggregations.size(); ++i) {
            if (!QueryAggregation.isSameAs(a.queryAggregations.get(i), b.queryAggregations.get(i))) {
                return false;
            }
        }
    ...
    public String getShortestPathWeight() {
        return shortestPathWeight;
    }

    public void setShortestPathWeight(String shortestPathWeight) {
