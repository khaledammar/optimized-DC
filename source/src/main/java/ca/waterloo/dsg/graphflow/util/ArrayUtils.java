...
public class ArrayUtils {
    ...
    public static long[] resizeIfNecessary(long[] array, int minCapacity, long defaultValue) {
        ...
        long[] newArray = Arrays.copyOf(array, ArrayUtils.getNewCapacity(array.length, minCapacity));
    ...
    public static double[] resizeIfNecessary(double[] array, int minCapacity, double defaultValue) {
        ...
        double[] newArray = Arrays.copyOf(array, ArrayUtils.getNewCapacity(array.length, minCapacity));
        for (int i = array.length; i < newArray.length; ++i) {
            newArray[i] = defaultValue;
        }
        return newArray;
     ...
     * @see #resizeIfNecessary(Object[], int)
     */
    public static int[] resizeIfNecessary(int[] array, int minCapacity, int defaultValue) {
        if (minCapacity <= array.length) {
            return array;
        }
        int[] newArray = Arrays.copyOf(array, ArrayUtils.getNewCapacity(array.length, minCapacity));
        for (int i = array.length; i < newArray.length; ++i) {
            newArray[i] = defaultValue;
        }
        return newArray;
