...
public abstract class PropertyReadingOperator extends AbstractOperator {
    ...
    private static final int MAX_STRING_BUILDER_LENGTH = 10000;
    ...
    protected Object getPropertyOrId(MatchQueryOutput matchQueryOutput,
        ...
        switch (propertyDescriptor.descriptorType) {
            case EDGE_ID:
                return matchQueryOutput.edgeDescriptors.get(index).edgeId;
            case EDGE_PROPERTY:
                return EdgeStore.getInstance().getProperty(matchQueryOutput.edgeDescriptors.
                    get(index).edgeId, key);
            case VERTEX_ID:
