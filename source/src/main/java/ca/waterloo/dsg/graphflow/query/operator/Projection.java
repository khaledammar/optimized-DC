...
public class Projection extends AbstractDBOperator {
    ...
    public Projection(AbstractDBOperator nextOperator, List<Integer> vertexIndicesToProject) {
        super(nextOperator);
        this.vertexIndicesToProject = vertexIndicesToProject != null ? vertexIndicesToProject : new ArrayList<>();
    ...
    public String getHumanReadableOperator() {
        ...
        appendListAsCommaSeparatedString(stringBuilder, vertexIndicesToProject, "VertexIndicesToProject");
