...
/**
 *
 * This is a back version of NewBidirUnweightedDifferentialBFS
 * I am trying to make it choose the smallest frontier
 *
 */
 ...
 */
public class AlternatingBidirUnweightedDifferentialBFS implements DifferentialBFS {
    ...
    public AlternatingBidirUnweightedDifferentialBFS(int source, int destination,
                                                     boolean backtrack) {

    //    System.out.println("\nNewBidirUnweightedDifferentialBFS - constructor");

        this.backtrack = backtrack;
        this.fwDiffBFS = new NewUnidirectionalUnweightedDifferentialBFS(source, destination,
            Direction.FORWARD, backtrack);
        this.bwDiffBFS = new NewUnidirectionalUnweightedDifferentialBFS(destination, source,
            Direction.BACKWARD, backtrack);
    ...
    public void continueBFS() {
        ...
        while (!fwDiffBFS.distances.isFrontierEmpty(fwDiffBFS.distances.latestIteration) &&
               !bwDiffBFS.distances.isFrontierEmpty(bwDiffBFS.distances.latestIteration) &&
    ...
    //    System.out.println("\nExecute Differential");
     ...
     //   System.out.println("There are vertices to Fix");
        ...
        int totalTimeToFix = fwDiffBFS.distances.latestIteration + 
            bwDiffBFS.distances.latestIteration;
     ...
     //   System.out.println("totalTimeToFix = "+totalTimeToFix);
        ...
        int timeToFixForDiffBFS = -1;
        int lastTimeFixedForOtherDiffBFS = -1;
        ...
        //    System.out.println("===> Time "+t+" "+myDirection);
            ...
            timeToFixForDiffBFS = (t % 2 == 1) ? (t+1)/2 : t/2;
        ...
        //    System.out.println("fixOneBFSStep - "+timeToFixForDiffBFS);
            ...
            if (t < totalTimeToFix && ( diffBFSToFix.distances.isFrontierEmpty(timeToFixForDiffBFS) ||
                (foundIntersectionWhileFixing = foundIntersectionAtTime(diffBFSToFix, otherDiffBFS,
        ...
        */
        ...
        boolean intersectionIsNotEmpty = t > totalTimeToFix ? !intersection.isEmpty() : 
    ...
    private void updateIntersection(NewUnidirectionalUnweightedDifferentialBFS diffBFSToFix,
        ...
        int latestIteration = diffBFSToFix.distances.latestIteration;
        for (int vertexFixed : diffBFSToFix.verticesToFix.iterVPairsList.get(latestIteration)) {
            if (intersection.contains(vertexFixed)) {
                if (Double.MAX_VALUE == diffBFSToFix.distances.getDistance(vertexFixed,
                    latestIteration)) {
    ...
    private boolean foundIntersectionAtTime(NewUnidirectionalUnweightedDifferentialBFS diffBFSToFix,
        NewUnidirectionalUnweightedDifferentialBFS otherDiffBFS, int timeToFixForDiffBFS,
        int lastTimeFixedForOtherDiffBFS) {
        ...
        for (int vertexFixed : diffBFSToFix.verticesToFix.iterVPairsList.get(timeToFixForDiffBFS)) {
