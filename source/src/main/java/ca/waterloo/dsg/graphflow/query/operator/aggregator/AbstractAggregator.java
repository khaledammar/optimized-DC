...
public abstract class AbstractAggregator {
    ...
    public void aggregate(int index, Object value) {
        if (null == value) {
            throw new IllegalArgumentException("Cannot aggregate null value. index: " + index + " object: null");
        }
        if (value instanceof Double) {
            ...
            throw new UnsupportedOperationException(
                    "Aggregating instances of " + value.getClass().getSimpleName() + " is not supported by " +
    ...
    protected void aggregateInt(int index, int intValue) {
        throw new UnsupportedOperationException(
                "Aggregating int values is not supported by " + this.getClass().getSimpleName() + ".");
    }
    ...
    protected void aggregateDouble(int index, double doubleValue) {
        throw new UnsupportedOperationException(
                "Aggregating double values is not supported by " + this.getClass().getSimpleName() + ".");
    }
