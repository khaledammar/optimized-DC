...
@rem ##########################################################################
@rem
@rem  experiment-new startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and EXPERIMENT_NEW_OPTS to pass JVM options to this script.
...
@rem Execute experiment-new
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXPERIMENT_NEW_OPTS%  -classpath "%CLASSPATH%" ca.waterloo.dsg.graphflow.ExperimentNew %*
...
:fail
rem Set variable EXPERIMENT_NEW_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%EXPERIMENT_NEW_EXIT_CONSOLE%" exit 1
exit /b 1
