...
@rem ##########################################################################
@rem
@rem  graphflow-cli startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and GRAPHFLOW_CLI_OPTS to pass JVM options to this script.
...
@rem Execute graphflow-cli
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRAPHFLOW_CLI_OPTS%  -classpath "%CLASSPATH%" ca.waterloo.dsg.graphflow.client.cli.GraphflowCliRunner %*
...
:fail
rem Set variable GRAPHFLOW_CLI_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%GRAPHFLOW_CLI_EXIT_CONSOLE%" exit 1
exit /b 1
